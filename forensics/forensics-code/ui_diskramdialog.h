/********************************************************************************
** Form generated from reading UI file 'diskramdialog.ui'
**
...
#ifndef UI_DISKRAMDIALOG_H
#define UI_DISKRAMDIALOG_H
...
public:
    ...
    void setupUi(QDialog *diskramDialog)
    {
        if (diskramDialog->objectName().isEmpty())
            diskramDialog->setObjectName(QStringLiteral("diskramDialog"));
        diskramDialog->resize(750, 430);
        diskramDialog->setStyleSheet(QLatin1String("QDialog#diskramDialog{\n"
"	background-image: url(:/images/ram/bg.png);\n"
"}"));
        checkBox = new QCheckBox(diskramDialog);
...
"}"));
        ...
        checkBox_34 = new QCheckBox(diskramDialog);
...
"}"));
        ...
        treeWidget = new QTreeWidget(diskramDialog);
...
"}"));
        ...
        checkBox_33 = new QCheckBox(diskramDialog);
...
"}"));
        ...
        comboBox = new QComboBox(diskramDialog);
...
" }"));
        ...
        pushButton_3 = new QPushButton(diskramDialog);
...
"	color:#ffffff;\n"
"}"));
        checkBox_32 = new QCheckBox(diskramDialog);
...
"}"));
        ...
        lineEdit = new QLineEdit(diskramDialog);
...
"	font:14px;\n"
"}"));
        pushButton = new QPushButton(diskramDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_6 = new QPushButton(diskramDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_5 = new QPushButton(diskramDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_2 = new QPushButton(diskramDialog);
...
"	border-radius: 0px;\n"
"}"));
        checkBox_3 = new QCheckBox(diskramDialog);
...
""));
        ...
        progressBar_13 = new QProgressBar(diskramDialog);
...
"}"));
        ...
        widget = new QWidget(diskramDialog);
...
"}"));
        ...
        titlebar = new QWidget(diskramDialog);
...
"}"));
        ...
        label_2->setGeometry(QRect(270, 4, 241, 41));
        label_2->setStyleSheet(QLatin1String("QLabel#label_2{\n"
"	font: 14pt \"MS Shell Dlg 2\";\n"
"	color: #787d97;\n"
"}"));
        checkBox_31 = new QCheckBox(diskramDialog);
...
"}"));
        ...
        pushButton_4 = new QPushButton(diskramDialog);
...
"}"));
        ...
        retranslateUi(diskramDialog);

        QMetaObject::connectSlotsByName(diskramDialog);
    } // setupUi

    void retranslateUi(QDialog *diskramDialog)
    {
        diskramDialog->setWindowTitle(QApplication::translate("diskramDialog", "Dialog", Q_NULLPTR));
        checkBox->setText(QString());
        checkBox_34->setText(QApplication::translate("diskramDialog", "Checked Desable", Q_NULLPTR));

        const bool __sortingEnabled = treeWidget->isSortingEnabled();
        treeWidget->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->topLevelItem(0);
        ___qtreewidgetitem->setText(0, QApplication::translate("diskramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem1 = ___qtreewidgetitem->child(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("diskramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem->child(1);
        ___qtreewidgetitem2->setText(0, QApplication::translate("diskramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem->child(2);
        ___qtreewidgetitem3->setText(0, QApplication::translate("diskramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem4 = ___qtreewidgetitem3->child(0);
        ___qtreewidgetitem4->setText(0, QApplication::translate("diskramDialog", "TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem5 = ___qtreewidgetitem3->child(1);
        ___qtreewidgetitem5->setText(0, QApplication::translate("diskramDialog", "TreeView", Q_NULLPTR));
        treeWidget->setSortingEnabled(__sortingEnabled);

        checkBox_33->setText(QApplication::translate("diskramDialog", "Check Desable", Q_NULLPTR));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("diskramDialog", "ComboBox1", Q_NULLPTR)
         << QApplication::translate("diskramDialog", "ComboBox2", Q_NULLPTR)
         << QApplication::translate("diskramDialog", "ComboBox3", Q_NULLPTR)
        );
        pushButton_3->setText(QApplication::translate("diskramDialog", "      Redo", Q_NULLPTR));
        checkBox_32->setText(QApplication::translate("diskramDialog", "CheckBox On", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("diskramDialog", "c:\\ProgramFiles\\Adbobe\\Adbobe2017", Q_NULLPTR));
        pushButton->setText(QApplication::translate("diskramDialog", "Button", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("diskramDialog", "Button", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("diskramDialog", "Button", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("diskramDialog", "Browse", Q_NULLPTR));
        checkBox_3->setText(QString());
        pushButton_7->setText(QApplication::translate("diskramDialog", "Step     1", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("diskramDialog", "Step     3", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("diskramDialog", "Step     2", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("diskramDialog", "Step     4", Q_NULLPTR));
        minbutton->setText(QString());
        closebutton->setText(QString());
        label_2->setText(QApplication::translate("diskramDialog", "Disk+Ram Image Acquisition", Q_NULLPTR));
        checkBox_31->setText(QApplication::translate("diskramDialog", "CheckBox Off", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("diskramDialog", "Button", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class diskramDialog: public Ui_diskramDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DISKRAMDIALOG_H
