...
public:
    ...
    void setupUi(QDialog *driveDialog)
    {
        ...
        driveDialog->resize(750, 430);
        driveDialog->setStyleSheet(QLatin1String("QDialog#driveDialog{\n"
...
"}"));
        ...
        checkBox_34 = new QCheckBox(driveDialog);
...
"}"));
        ...
        treeWidget = new QTreeWidget(driveDialog);
...
"}"));
        ...
        checkBox_33 = new QCheckBox(driveDialog);
...
"}"));
        ...
        comboBox = new QComboBox(driveDialog);
...
" }"));
        ...
        pushButton_3 = new QPushButton(driveDialog);
...
"	color:#ffffff;\n"
"}"));
        checkBox_32 = new QCheckBox(driveDialog);
...
"}"));
        ...
        lineEdit = new QLineEdit(driveDialog);
...
"	font:14px;\n"
"}"));
        pushButton = new QPushButton(driveDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_6 = new QPushButton(driveDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_5 = new QPushButton(driveDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_2 = new QPushButton(driveDialog);
...
"	border-radius: 0px;\n"
"}"));
        checkBox_3 = new QCheckBox(driveDialog);
...
""));
        ...
        progressBar_13 = new QProgressBar(driveDialog);
...
"}"));
        ...
        widget = new QWidget(driveDialog);
...
"}"));
        ...
        titlebar = new QWidget(driveDialog);
...
"	color: #787d97;\n"
"}"));
        checkBox_31 = new QCheckBox(driveDialog);
...
"}"));
        ...
        pushButton_4 = new QPushButton(driveDialog);
...
"}"));
    ...
    {
        driveDialog->setWindowTitle(QApplication::translate("driveDialog", "Dialog", Q_NULLPTR));
        checkBox->setText(QString());
        checkBox_34->setText(QApplication::translate("driveDialog", "Checked Desable", Q_NULLPTR));

        const bool __sortingEnabled = treeWidget->isSortingEnabled();
        treeWidget->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->topLevelItem(0);
        ___qtreewidgetitem->setText(0, QApplication::translate("driveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem1 = ___qtreewidgetitem->child(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("driveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem->child(1);
        ___qtreewidgetitem2->setText(0, QApplication::translate("driveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem->child(2);
        ___qtreewidgetitem3->setText(0, QApplication::translate("driveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem4 = ___qtreewidgetitem3->child(0);
        ___qtreewidgetitem4->setText(0, QApplication::translate("driveDialog", "TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem5 = ___qtreewidgetitem3->child(1);
        ___qtreewidgetitem5->setText(0, QApplication::translate("driveDialog", "TreeView", Q_NULLPTR));
        treeWidget->setSortingEnabled(__sortingEnabled);

        checkBox_33->setText(QApplication::translate("driveDialog", "Check Desable", Q_NULLPTR));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("driveDialog", "ComboBox1", Q_NULLPTR)
         << QApplication::translate("driveDialog", "ComboBox2", Q_NULLPTR)
         << QApplication::translate("driveDialog", "ComboBox3", Q_NULLPTR)
        );
        pushButton_3->setText(QApplication::translate("driveDialog", "      Redo", Q_NULLPTR));
        checkBox_32->setText(QApplication::translate("driveDialog", "CheckBox On", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("driveDialog", "c:\\ProgramFiles\\Adbobe\\Adbobe2017", Q_NULLPTR));
        pushButton->setText(QApplication::translate("driveDialog", "Button", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("driveDialog", "Button", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("driveDialog", "Button", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("driveDialog", "Browse", Q_NULLPTR));
        checkBox_3->setText(QString());
        pushButton_7->setText(QApplication::translate("driveDialog", "Step     1", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("driveDialog", "Step     3", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("driveDialog", "Step     2", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("driveDialog", "Step     4", Q_NULLPTR));
        minbutton->setText(QString());
        closebutton->setText(QString());
        label_2->setText(QApplication::translate("driveDialog", "Acquire Drive Image", Q_NULLPTR));
        checkBox_31->setText(QApplication::translate("driveDialog", "CheckBox Off", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("driveDialog", "Button", Q_NULLPTR));
    } // retranslateUi
