...
public:
    ...
    void setupUi(QDialog *saveDialog)
    {
        ...
        saveDialog->resize(750, 430);
        saveDialog->setStyleSheet(QLatin1String("QDialog#saveDialog{\n"
"	background-image: url(:/images/ram/bg.png);\n"
"}"));
        progressBar_13 = new QProgressBar(saveDialog);
...
"}"));
        ...
        treeWidget = new QTreeWidget(saveDialog);
...
"	font:14px;\n"
"}"));
        checkBox_33 = new QCheckBox(saveDialog);
...
"border-radius:3px;\n"
"}"));
        checkBox_34 = new QCheckBox(saveDialog);
...
"}"));
        ...
        checkBox = new QCheckBox(saveDialog);
...
"	color:#ffffff;\n"
"}"));
        pushButton_5 = new QPushButton(saveDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_6 = new QPushButton(saveDialog);
...
"border-radius:3px;\n"
"}"));
        titlebar = new QWidget(saveDialog);
...
"}"));
        ...
        label_2->setGeometry(QRect(280, 4, 171, 41));
...
" }"));
        ...
        pushButton_4 = new QPushButton(saveDialog);
...
"border-radius:3px;\n"
"}"));
        checkBox_32 = new QCheckBox(saveDialog);
...
"}"));
        ...
        checkBox_31 = new QCheckBox(saveDialog);
...
"}"));
        ...
        checkBox_3 = new QCheckBox(saveDialog);
...
""));
    ...
    {
        saveDialog->setWindowTitle(QApplication::translate("saveDialog", "Dialog", Q_NULLPTR));
        pushButton_7->setText(QApplication::translate("saveDialog", "Step     1", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("saveDialog", "Step     3", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("saveDialog", "Step     2", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("saveDialog", "Step     4", Q_NULLPTR));

        const bool __sortingEnabled = treeWidget->isSortingEnabled();
        treeWidget->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->topLevelItem(0);
        ___qtreewidgetitem->setText(0, QApplication::translate("saveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem1 = ___qtreewidgetitem->child(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("saveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem->child(1);
        ___qtreewidgetitem2->setText(0, QApplication::translate("saveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem->child(2);
        ___qtreewidgetitem3->setText(0, QApplication::translate("saveDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem4 = ___qtreewidgetitem3->child(0);
        ___qtreewidgetitem4->setText(0, QApplication::translate("saveDialog", "TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem5 = ___qtreewidgetitem3->child(1);
        ___qtreewidgetitem5->setText(0, QApplication::translate("saveDialog", "TreeView", Q_NULLPTR));
        treeWidget->setSortingEnabled(__sortingEnabled);

        lineEdit->setText(QApplication::translate("saveDialog", "c:\\ProgramFiles\\Adbobe\\Adbobe2017", Q_NULLPTR));
        checkBox_33->setText(QApplication::translate("saveDialog", "Check Desable", Q_NULLPTR));
        pushButton_2->setText(QApplication::translate("saveDialog", "Browse", Q_NULLPTR));
        pushButton->setText(QApplication::translate("saveDialog", "Button", Q_NULLPTR));
        checkBox_34->setText(QApplication::translate("saveDialog", "Checked Desable", Q_NULLPTR));
        checkBox->setText(QString());
        pushButton_3->setText(QApplication::translate("saveDialog", "      Redo", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("saveDialog", "Button", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("saveDialog", "Button", Q_NULLPTR));
        minbutton->setText(QString());
        closebutton->setText(QString());
        label_2->setText(QApplication::translate("saveDialog", "Save Startup Entries", Q_NULLPTR));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("saveDialog", "ComboBox1", Q_NULLPTR)
         << QApplication::translate("saveDialog", "ComboBox2", Q_NULLPTR)
         << QApplication::translate("saveDialog", "ComboBox3", Q_NULLPTR)
        );
        pushButton_4->setText(QApplication::translate("saveDialog", "Button", Q_NULLPTR));
        checkBox_32->setText(QApplication::translate("saveDialog", "CheckBox On", Q_NULLPTR));
        checkBox_31->setText(QApplication::translate("saveDialog", "CheckBox Off", Q_NULLPTR));
