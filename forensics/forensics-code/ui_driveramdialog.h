/********************************************************************************
** Form generated from reading UI file 'driveramdialog.ui'
**
...
#ifndef UI_DRIVERAMDIALOG_H
#define UI_DRIVERAMDIALOG_H
...
public:
    ...
    void setupUi(QDialog *driveramDialog)
    {
        if (driveramDialog->objectName().isEmpty())
            driveramDialog->setObjectName(QStringLiteral("driveramDialog"));
        driveramDialog->resize(750, 430);
        driveramDialog->setStyleSheet(QLatin1String("QDialog#driveramDialog{\n"
"	background-image: url(:/images/ram/bg.png);\n"
"}"));
        checkBox_3 = new QCheckBox(driveramDialog);
...
""));
        ...
        pushButton_2 = new QPushButton(driveramDialog);
...
"	border-radius: 0px;\n"
"}"));
        pushButton_4 = new QPushButton(driveramDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton = new QPushButton(driveramDialog);
...
"border-radius:3px;\n"
"}"));
        checkBox_33 = new QCheckBox(driveramDialog);
...
"}"));
        ...
        treeWidget = new QTreeWidget(driveramDialog);
...
"}"));
        ...
        pushButton_3 = new QPushButton(driveramDialog);
...
"	color:#ffffff;\n"
"}"));
        pushButton_5 = new QPushButton(driveramDialog);
...
"border-radius:3px;\n"
"}"));
        pushButton_6 = new QPushButton(driveramDialog);
...
"border-radius:3px;\n"
"}"));
        comboBox = new QComboBox(driveramDialog);
...
" }"));
        ...
        lineEdit = new QLineEdit(driveramDialog);
...
"	font:14px;\n"
"}"));
        titlebar = new QWidget(driveramDialog);
...
"}"));
        ...
        label_2->setGeometry(QRect(240, 4, 251, 41));
        label_2->setStyleSheet(QLatin1String("QLabel#label_2{\n"
"	font: 14pt \"MS Shell Dlg 2\";\n"
"	color: #787d97;\n"
"}"));
        checkBox_32 = new QCheckBox(driveramDialog);
...
"}"));
        ...
        checkBox_31 = new QCheckBox(driveramDialog);
...
"}"));
        ...
        checkBox = new QCheckBox(driveramDialog);
...
"}"));
        ...
        checkBox_34 = new QCheckBox(driveramDialog);
...
"}"));
        ...
        widget = new QWidget(driveramDialog);
...
"}"));
        ...
        progressBar_13 = new QProgressBar(driveramDialog);
...
"}"));
        ...
        retranslateUi(driveramDialog);

        QMetaObject::connectSlotsByName(driveramDialog);
    } // setupUi

    void retranslateUi(QDialog *driveramDialog)
    {
        driveramDialog->setWindowTitle(QApplication::translate("driveramDialog", "Dialog", Q_NULLPTR));
        checkBox_3->setText(QString());
        pushButton_2->setText(QApplication::translate("driveramDialog", "Browse", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("driveramDialog", "Button", Q_NULLPTR));
        pushButton->setText(QApplication::translate("driveramDialog", "Button", Q_NULLPTR));
        checkBox_33->setText(QApplication::translate("driveramDialog", "Check Desable", Q_NULLPTR));

        const bool __sortingEnabled = treeWidget->isSortingEnabled();
        treeWidget->setSortingEnabled(false);
        QTreeWidgetItem *___qtreewidgetitem = treeWidget->topLevelItem(0);
        ___qtreewidgetitem->setText(0, QApplication::translate("driveramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem1 = ___qtreewidgetitem->child(0);
        ___qtreewidgetitem1->setText(0, QApplication::translate("driveramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem2 = ___qtreewidgetitem->child(1);
        ___qtreewidgetitem2->setText(0, QApplication::translate("driveramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem3 = ___qtreewidgetitem->child(2);
        ___qtreewidgetitem3->setText(0, QApplication::translate("driveramDialog", " TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem4 = ___qtreewidgetitem3->child(0);
        ___qtreewidgetitem4->setText(0, QApplication::translate("driveramDialog", "TreeView", Q_NULLPTR));
        QTreeWidgetItem *___qtreewidgetitem5 = ___qtreewidgetitem3->child(1);
        ___qtreewidgetitem5->setText(0, QApplication::translate("driveramDialog", "TreeView", Q_NULLPTR));
        treeWidget->setSortingEnabled(__sortingEnabled);

        pushButton_3->setText(QApplication::translate("driveramDialog", "      Redo", Q_NULLPTR));
        pushButton_5->setText(QApplication::translate("driveramDialog", "Button", Q_NULLPTR));
        pushButton_6->setText(QApplication::translate("driveramDialog", "Button", Q_NULLPTR));
        comboBox->clear();
        comboBox->insertItems(0, QStringList()
         << QApplication::translate("driveramDialog", "ComboBox1", Q_NULLPTR)
         << QApplication::translate("driveramDialog", "ComboBox2", Q_NULLPTR)
         << QApplication::translate("driveramDialog", "ComboBox3", Q_NULLPTR)
        );
        lineEdit->setText(QApplication::translate("driveramDialog", "c:\\ProgramFiles\\Adbobe\\Adbobe2017", Q_NULLPTR));
        minbutton->setText(QString());
        closebutton->setText(QString());
        label_2->setText(QApplication::translate("driveramDialog", "Drive+Ram Image Acquisition", Q_NULLPTR));
        checkBox_32->setText(QApplication::translate("driveramDialog", "CheckBox On", Q_NULLPTR));
        checkBox_31->setText(QApplication::translate("driveramDialog", "CheckBox Off", Q_NULLPTR));
        checkBox->setText(QString());
        checkBox_34->setText(QApplication::translate("driveramDialog", "Checked Desable", Q_NULLPTR));
        pushButton_7->setText(QApplication::translate("driveramDialog", "Step     1", Q_NULLPTR));
        pushButton_9->setText(QApplication::translate("driveramDialog", "Step     3", Q_NULLPTR));
        pushButton_8->setText(QApplication::translate("driveramDialog", "Step     2", Q_NULLPTR));
        pushButton_10->setText(QApplication::translate("driveramDialog", "Step     4", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class driveramDialog: public Ui_driveramDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DRIVERAMDIALOG_H
