...
void driveDialog::mouseMoveEvent(QMouseEvent *event)
{
...
void driveDialog::mousePressEvent(QMouseEvent *event)
{
...
void driveDialog::mouseReleaseEvent(QMouseEvent *event)
{
    m_capturedMenuBar = false;
}

void driveDialog::on_checkBox_clicked()
{
...
void driveDialog::on_pushButton_7_clicked()
{
    ui->pushButton_8->setChecked(false);
    ui->pushButton_9->setChecked(false);
    ui->pushButton_10->setChecked(false);
}
void driveDialog::on_pushButton_8_clicked()
{
...
void driveDialog::on_pushButton_9_clicked()
{
    ui->pushButton_8->setChecked(false);
    ui->pushButton_7->setChecked(false);
    ui->pushButton_10->setChecked(false);
...
void driveDialog::on_pushButton_10_clicked()
{
    ui->pushButton_8->setChecked(false);
    ui->pushButton_9->setChecked(false);
    ui->pushButton_7->setChecked(false);
